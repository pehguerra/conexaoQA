        ...
        <Fragment>
            {profile === null || loading ? <Spinner /> : 
                <Fragment>
                    ...
                    {auth.isAuthenticated && auth.loading === false && auth.user._id === profile.user._id && (<Link to="/editar-perfil" className="btn btn-dark">
                        Editar Perfil
                    </Link>)}
                    <div className="profile-grid my-1">
                        ...
                        <div className="profile-edu bg-white p-2">
                            ...
                            {profile.education.length > 0 ? 
                                ...
                                : 
                                (<h4>Não há formações acadêmicas</h4>)
                            }
                        </div>
